...
from utils import CurveDataSplitter, CurvesPreprocessor, GDSC1RawDatasetInter, GDSC1RawDatasetExtrap, GDSC1RawDatasetEpoint
...
if __name__ == "__main__":
    ...
    train_ds = GDSC1RawDatasetExtrap(train_data["drugs"],
                          train_data["lines"],
                          train_data["inhibs"],
                          train_data["concs"],
                          test_data["drugs"],
                          ...
                          test_data["inhibs"],
                          test_data["concs"])
    test_ds = GDSC1RawDatasetEpoint(test_data["drugs"],
                          test_data["lines"],
                              test_data["inhibs"],
                              test_data["concs"])
